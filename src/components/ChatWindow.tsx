...
function ChatWindowInner<TMeta = Record<string, unknown>>({ messages, typing, codeTheme = 'dark', headless = false, renderMessage, markdownProps, markdownSanitizer, hiddenRoles, showSystemMessages, onEdit, onRegenerate, onDelete, onCopy, onFeedback, error, onRetry, streamingMessageId, className, style, ...rest }: ChatWindowProps<TMeta>, ref: React.ForwardedRef<HTMLDivElement>) {
  React.useEffect(() => {
