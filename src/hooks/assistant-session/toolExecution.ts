...
export function useToolExecution<TMeta>(deps: ToolExecutionDeps<TMeta>): ToolExecution<TMeta> {
  ...
  }, [continueOnToolErrorRef, createToolCallContext, isAssistantSessionActive, messagesRef, onToolCallRef, safeNotifyToolCall, setToolErrorOutput, setToolOutput, toolsRef, updateSessionMessages]);
