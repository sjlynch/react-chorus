...
async function verifyConsumerBundleBudgets() {
  ...
  const measurements = {};
  const entryBudgets = [
    { label: 'root entry initial JS', entry: 'root', maxSize: 189 * KiB, maxGzip: 62 * KiB },
    { label: 'headless entry initial JS', entry: 'headless', maxSize: 189 * KiB, maxGzip: 62 * KiB },
