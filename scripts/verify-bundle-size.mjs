...
async function verifyConsumerBundleBudgets() {
  ...
  const measurements = {};
  const entryBudgets = [
    { label: 'root entry initial JS', entry: 'root', maxSize: 180 * KiB, maxGzip: 60 * KiB },
    { label: 'headless entry initial JS', entry: 'headless', maxSize: 180 * KiB, maxGzip: 60 * KiB },
    { label: 'root useChorusStream import initial JS', entry: 'rootUseChorusStream', maxSize: 49 * KiB, maxGzip: 16 * KiB },
    { label: 'root Markdown import initial JS', entry: 'rootMarkdown', maxSize: 85 * KiB, maxGzip: 30 * KiB },
    { label: 'root ChatWindow import initial JS', entry: 'rootChatWindow', maxSize: 116 * KiB, maxGzip: 40 * KiB },
