...
async function verifyConsumerBundleBudgets() {
  ...
  const measurements = {};
  const entryBudgets = [
    { label: 'root entry initial JS', entry: 'root', maxSize: 179 * KiB, maxGzip: 60 * KiB },
    { label: 'headless entry initial JS', entry: 'headless', maxSize: 179 * KiB, maxGzip: 60 * KiB },
