...
async function verifyConsumerBundleBudgets() {
  ...
  const measurements = {};
  const entryBudgets = [
    { label: 'root entry initial JS', entry: 'root', maxSize: 201 * KiB, maxGzip: 67 * KiB },
    { label: 'headless entry initial JS', entry: 'headless', maxSize: 201 * KiB, maxGzip: 67 * KiB },
    { label: 'root useChorusStream import initial JS', entry: 'rootUseChorusStream', maxSize: 57 * KiB, maxGzip: 18 * KiB },
