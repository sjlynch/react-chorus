...
|-------|------------|------|-------|
| `react-chorus` (`<Chorus>`) | 276.2 kB | 87.7 kB | Full widget path; includes Markdown parsing/sanitization and icons. |
| `react-chorus/headless` | 276.5 kB | 87.8 kB | Headless defaults, same behavior surface. |
