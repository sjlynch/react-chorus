...
| [Connector capabilities](connectors.md) | Provider parity matrix for usage metadata, reasoning, citations, tool calls, multimodal input/output, and code-execution limitations. |
