...
|-------|------------|------|-------|
| `react-chorus` (`<Chorus>`) | 148.1 kB | 50.7 kB | Full widget path; includes Markdown parsing/sanitization and icons. |
| `react-chorus/headless` | 148.5 kB | 50.9 kB | Headless defaults, same behavior surface. |
