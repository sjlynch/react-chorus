...
|-------|------------|------|-------|
| `react-chorus` (`<Chorus>`) | 154.8 kB | 52.9 kB | Full widget path; includes Markdown parsing/sanitization and icons. |
| `react-chorus/headless` | 155.1 kB | 53.0 kB | Headless defaults, same behavior surface. |
| `react-chorus` (`useChorusStream`) | 35.8 kB | 11.9 kB | Root hook import; CI fails if it pulls UI, Markdown, or icon dependencies. |
...
| `react-chorus/provider-requests` | 8.5 kB | 2.5 kB | Provider request mappers only; no React/UI/Markdown runtime. |
