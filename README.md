...
|-------|------------|------|-------|
| `react-chorus` (`<Chorus>`) | 185.0 kB | 60.8 kB | Full widget path; includes Markdown parsing/sanitization and icons. |
| `react-chorus/headless` | 185.3 kB | 61.0 kB | Headless defaults, same behavior surface. |
| `react-chorus` (`useChorusStream`) | 50.5 kB | 15.6 kB | Root hook import; CI fails if it pulls UI, Markdown, or icon dependencies. |
...
| `react-chorus/provider-requests` | 9.9 kB | 3.0 kB | Provider request mappers and tool serializers; no React/UI/Markdown runtime. |
