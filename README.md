...
|-------|------------|------|-------|
| `react-chorus` (`<Chorus>`) | 165.1 kB | 55.7 kB | Full widget path; includes Markdown parsing/sanitization and icons. |
| `react-chorus/headless` | 165.5 kB | 55.8 kB | Headless defaults, same behavior surface. |
