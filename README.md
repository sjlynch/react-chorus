...
|-------|------------|------|-------|
| `react-chorus` (`<Chorus>`) | 163.7 kB | 55.3 kB | Full widget path; includes Markdown parsing/sanitization and icons. |
| `react-chorus/headless` | 164.0 kB | 55.4 kB | Headless defaults, same behavior surface. |
