...
|-------|------------|------|-------|
| `react-chorus` (`<Chorus>`) | 211.8 kB | 68.3 kB | Full widget path; includes Markdown parsing/sanitization and icons. |
| `react-chorus/headless` | 212.1 kB | 68.4 kB | Headless defaults, same behavior surface. |
