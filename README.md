...
|-------|------------|------|-------|
| `react-chorus` (`<Chorus>`) | 174.7 kB | 58.6 kB | Full widget path; includes Markdown parsing/sanitization and icons. |
| `react-chorus/headless` | 175.1 kB | 58.8 kB | Headless defaults, same behavior surface. |
