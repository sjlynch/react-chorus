...
|-------|------------|------|-------|
| `react-chorus` (`<Chorus>`) | 152.7 kB | 52.0 kB | Full widget path; includes Markdown parsing/sanitization and icons. |
| `react-chorus/headless` | 153.0 kB | 52.2 kB | Headless defaults, same behavior surface. |
| `react-chorus` (`useChorusStream`) | 34.4 kB | 11.3 kB | Root hook import; CI fails if it pulls UI, Markdown, or icon dependencies. |
...
| `react-chorus/provider-requests` | 8.4 kB | 2.5 kB | Provider request mappers only; no React/UI/Markdown runtime. |
